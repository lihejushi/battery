...
using XT.MVC.Core.ComponentModel;
using XT.MVC.Core.Plugins;
using XT.MVC.Core.Helper;
...
namespace XT.MVC.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static IEnumerable<KeyValuePair<FileInfo, PluginDescriptor>> GetDescriptionFilesAndDescriptors(DirectoryInfo pluginFolder)
        {
            ...
            //it's required: http://www.Lfmcommerce.com/boards/t/17455/load-plugins-based-on-their-displayorder-on-startup.aspx
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            if (plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name +
                                                    " file exists in a folder outside of the allowed LfmCommerce folder heirarchy");
        ...
        private static FileInfo InitializeMediumTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            if (shadowCopiedPlug.Exists)
            {
                ...
                else
                {
                    ...
                    //More info: http://www.Lfmcommerce.com/boards/t/11511/access-error-Lfmplugindiscountrulesbillingcountrydll.aspx?p=4#60838
