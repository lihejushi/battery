...
namespace Battery.Framework
{
    public class WebWorkContext : IWorkContext
    {
        ...
        private UserType _uType = UserType.Shop;
...
失败原因：{0}
        ...
        private void ParseWork()
        {
            ...
            if (app.IsAdmin)
            {
                ...
                else if (app.Platform == PlatformType.Company)
                {
                    _uCookie = _cookieHelper.GetCookieValue(ConstVar.GetIdentityCookieKey(UserType.Company));
                    _uType = UserType.Company;
                }
