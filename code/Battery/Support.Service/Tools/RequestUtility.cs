...
namespace Support.Service.Tools
{
    public static class RequestUtility
    {
        ...
        /// <returns></returns>
        public static string HttpGet(string url, CookieContainer cookieContainer = null, Encoding encoding = null, int timeOut = TIME_OUT)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, int timeOut = TIME_OUT)
        {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int timeOut = TIME_OUT, bool checkValidationResult = false, string contentType = "", string accept = "")
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Timeout = timeOut;
            ...
            request.Accept = string.IsNullOrEmpty(accept) ? "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8" : accept;
