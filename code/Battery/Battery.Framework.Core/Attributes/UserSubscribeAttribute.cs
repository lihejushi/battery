...
namespace Battery.Framework.Core.Attributes
{
    ...
    public class UserSubscribeAttribute : ActionFilterAttribute
    {
        ...
        private bool CheckAuthorize(ActionExecutingContext filterContext, out WX_SubscribeUsers userInfo)
        {
            ...
            userInfo = 
                filterContext.Controller.ViewData[ConstVar.WX_ViewBag_UserInfo] == null ? UserDAL.GetSubscribeUser(userContext.OpenId) 
                    : ((WX_SubscribeUsers)filterContext.Controller.ViewData[ConstVar.WX_ViewBag_UserInfo]);
