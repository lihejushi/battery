...
namespace Battery.Framework.Core.Controllers
{
    public class ContextController : BaseController
    {
        ...
        public string ZytDomain
        {
            get
            {
                return GlobalConfig.Get("ZytDomain");
            }
        }
        ...
        [NonAction]
        public virtual void BaseLogin(UserType identity,int shopId, int userId, string userName, string nickName, string openId)
        {
