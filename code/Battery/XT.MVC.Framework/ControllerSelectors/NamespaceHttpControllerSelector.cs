...
namespace XT.MVC.Framework.ControllerSelectors
{
    public class NamespaceHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            {
                throw new HttpResponseException(request.CreateResponse(HttpStatusCode.NotFound, new Result()
                {
                    Code = -100,
                    Message = string.Format("No route providing a controller name was found to match request URI '{0}'", new object[] { request.RequestUri }),
                }));
            }
