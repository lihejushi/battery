...
namespace XT.MVC.Framework.EmbeddedViews
{
    public class EmbeddedViewVirtualPathProvider : VirtualPathProvider
    {
        ...
        private bool IsEmbeddedView(string virtualPath)
        {
            ...
            for example: both GamePlatformManager.Plugin.Plugin1 and GamePlatformManager.Plugin.Plugin2 can have Views\Config\Configure.cshtml files
